<template>
  <div class="p-6 md:p-10 bg-gray-50 min-h-screen">
    ...
    <!-- Page Header -->
    <div class="mb-8">
      <h1 class="text-3xl font-bold text-gray-900 mb-1">Thêm trang mới</h1>
      <p class="text-gray-600">Điền thông tin để tạo trang mới</p>
    </div>
    ...
    <form @submit.prevent="handleSubmit" class="space-y-8">
      ...
      <div class="flex justify-end gap-4 pt-4 border-t mt-4">
        ...
        <button type="submit" :disabled="loading" class="bg-green-500 text-white rounded px-4 py-2 hover:bg-green-600 cursor-pointer disabled:opacity-50 disabled:cursor-not-allowed flex items-center">
